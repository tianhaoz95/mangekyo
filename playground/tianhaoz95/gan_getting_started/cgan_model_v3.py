...
class GeneratorModel_v3(keras.Model):
    def __init__(self):
        super(GeneratorModel_v3, self).__init__()
        ...
        # Expand (10,) to (7,7,128)
        self.embedder = keras.layers.Embedding(10, 100)
        self.dense_2 = keras.layers.Dense(7*7*128)
        self.reshape_2 = keras.layers.Reshape((7, 7, 128))
...
class DiscriminatorModel_v3(keras.Model):
    def __init__(self):
        super(DiscriminatorModel_v3, self).__init__()
        self.embedder = keras.layers.Embedding(10, 50)
        self.expand_layer = keras.layers.Dense(28*28*1)
        self.reshape_layer = keras.layers.Reshape((28, 28, 1))
        self.conv_1 = keras.layers.Conv2D(
            64, (5, 5), strides=2, padding='same', input_shape=(28, 28, 2))
